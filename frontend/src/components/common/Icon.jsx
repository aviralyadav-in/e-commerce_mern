...
export const PrinterIcon = make(
  p("M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2m-12 0v4h12v-4M6 14h12"),
);
export const MessageSquareIcon = make(
  p("M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"),
);
...
export const WhatsAppIcon = ({ className = "w-4 h-4", ...rest }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
